...
if __name__ == "__main__":
    convert_md_to_json("Recopilatorio_2011-2014.md", "webapp/src/data_2011_2014.json")
    convert_md_to_json("Recopilatorio_2015-2019.md", "webapp/src/data_2015_2019.json")
